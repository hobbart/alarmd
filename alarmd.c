...
char tel_nr[13]="+491748935075"; //Ziel-Nr. fuer SMS-Benachrichtigung
...
int i, j, res = 0;
int allowed_rfid_tags[5]={0, 4425480, 3190774, 6373179, 3184042}; //bekannte RFID-Tags
char personen[5][10]={"Unbekannt","Sven","Karsta","Julian","Timon"}; //bekannte Personen
