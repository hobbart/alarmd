...
pthread_t pir_thread[256], rfidd_thread, led_thread; //Thread-Identifier Array (opaque, IEEE POSIX 1003.1c standard)
...
int pir_warmup = 60; //60sec Aufwärmzeit für PIR-Sensoren
